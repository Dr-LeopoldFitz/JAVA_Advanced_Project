...
public class ChartRoom_Server extends JFrame {
    ...
    public static void main(String[] args) {
        ChartRoom_Server ts = new ChartRoom_Server();
        ts.launchFrame();
    }
        ...
        public void run() {
            try {
                while (bStart) {
                    ...
                    for (int i = 0; i < clients.size(); i++) { //依次发送每个人的消息到广播
